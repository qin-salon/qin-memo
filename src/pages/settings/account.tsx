    ...
    <div className="bg-white h-screen flex justify-center text-black">
      <div className="w-80">
        <div className="relative flex justify-center mb-6 py-3">
          <Button button id="backButton" bgColor="transparent" className="absolute left-0 top-0 mx-0 my-0 px-0 py-3.5">
            <ChevronLeft />
          </Button>
          <QinAccount />
        </div>
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <Button button id="" bgColor="gray" className="my-0 mx-0 text-xs">
            解除する
          </Button>
        </div>
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center">
            <AppleIcon className="fill-current" />
            <p className="ml-3 font-bold">Apple</p>
          </div>
          <Button button id="" bgColor="blue" className="my-0 mx-0 text-xs">
            連携する
          </Button>
        </div>
      </div>
